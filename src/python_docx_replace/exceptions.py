class InitialTagNotFound(Exception):
    def __init__(self, initial, end) -> None:
        super().__init__(
            f"The end tag '{end}' was found, but the initial tag '{initial}' wasn't found. Check your Word document and make sure you set the initial and end tags correctly."
        )
